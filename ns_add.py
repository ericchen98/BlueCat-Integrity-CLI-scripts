...
# v5.2.1 Correct indent error by Eden
...
'''
ns-add  -c config1 -v view1 -z test.corp -r ns1 -i a1.test.corp
ns-add  -c config1 -v view1 -z test.corp -i a1.test.corp -k
    ...
    try:
        if configuration:
                ...
                if view:
                    ...
                    type="NS"
                    # this is to allow adding rrname has dot (e.g. "a1.b1".test.corp)
                    properties = "parentZoneName="+zone  
                    ttl = "-1"
                    try:
                        ...
                        logMsg =  "Success: Added%srecord %s rdata %s (objId:%s)" % ( sameAsZone_Message,
                                    absolutename,rdata, rtn_id)
