...
'''
a-query -c config1 -v view1 -z test.corp -r pc1 
a-query -c config1 -v view1 -z test.corp -k
                ...
                if zone:
                    ...
                    if len(result_list) == 0: # no entity found
                        ...
                        for ent in result_list:
                            ...
                            # print (properties)
                            #     output : {'type': 'A', 'absoluteName': 'a1.test.corp', 'rdata': '10.0.0.1'}
                        ...
                        # to log only ( connect all IP together )
