...
#
'''
macPool-delete -c config1 -p macPool1 [-i]
        ...
        if configuration:
            ...
            if macPool:
                ...
                if macPoolid == 0:
                    ...
                    bam.delete(macPoolid)

                    #bam.delete does not return any return code. I
                    
                    logMsg =  "Success: MacPool %s is deleted." % (macPool)
