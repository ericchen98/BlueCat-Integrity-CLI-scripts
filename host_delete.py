...
# v5.4-20220402 rename host-delete-all.py to host-delete.py to meet backward compatibility 
...
'''
host-delete -c config1 -v view1 -z test.corp -r  host1
host-delete -c config1 -v view1 -z test.corp -k  (delete "same as zome" record)
                ...
                if zone:
                    ...
                    if ent['id'] == 0:  # host record NOT found. Do nothing, exist
                        ...
                        try:
                            ...
                            logMsg = "Success: delete%srecord %s (record deleted)" %  (sameAsZone_Message, 
                                        absolutename)
