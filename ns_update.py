...
'''
    ns-update -c config1 -v view1 -z test.corp -r ns1 -i pc1.test.corp --ni pc2.test.corp
    ns-update -c config1 -v view1 -z test.corp -i pc1.test.corp --ni pc2.test.corp -k
