...
'''
ns-delete -c config1 -v view1 -z test.corp -r pc1 -i rdata
ns-delete -c config1 -v view1 -z test.corp -i rdata -k
        ...
        if configuration:
            ...
            if view:
                ...
                if zone:
                    ...
                    if sameAsZone:
                        absolutename = zone # for sameAsZone record, absolutename should use zone name (e.g.test.corp)
                        rrName = ""         # since this is for same as zone record, set rrName = ''
                    else:
                    ...
                    if len(result_list) == 0: # no entity found
                        ...
                        for ent_json in result_list:
                            properties = bam.splitProp(ent_json)
                            ...
                            if properties['type']=="NS":
                                ...
                                if properties['rdata'] == rdata:
                                    ...
                                    #                + " IP: " + properties['rdata'] +" -> deleting...")
                                    
                                    print ( f"(*) Record: {properties['absoluteName']}, RData: {properties['rdata']} -> deleting...")
                                                    
                                    try:
                                        rtn = bam.delete( ent_json['id'] )
                                    ...
                                    print ( f"    Record: {properties['absoluteName']}, RData: {properties['rdata']}")
                        #endof [for ent_json in result_list:]
